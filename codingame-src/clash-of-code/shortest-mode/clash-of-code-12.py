...
#The Goal
#========
#Bob has in his SockBox Multiple pairs of socks with n different colors. the pairs are separated and distributed randomly on the box.
...
#given the number of the different sock colors he have....output the least amount of socks he should take out from #the box so he could have at least 2 socks of the same color.
